    ...
    return (
        <>
            <div className="DIDWalletDiv w-full primaryfont " >
                ...
                <div className="TextMobileImg flex flex-col mt-[50px] md:mt-[30px] gap-[50px] md:gap-[30px] lg:flex-row lg:justify-center lg:gap-[50px] items-center lg:min-h-[100vh] w-full m-auto max-w-[1440px] px-[20px] pt-[50px] pb-[150px] lg:pb-[20px] lg:pt-[20px]">
                    <div className='w-full max-w-[450px]  md:max-w-[822px]'>
                        <div className=' text-white text-[30px] md:text-[50px] xl:text-[80px] leading-[120%] font-[600] '>Secure Your Digital Identity <span className='spanText text-white'>with Our Web3 DID Wallet</span></div>
            ...
            <div className='primaryfont w-full bg-[linear-gradient(103.72deg,_rgba(0,_157,_218,_0.04)_0%,_rgba(98,_186,_71,_0.04)_97.95%)]'>
                <div className='grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-y-10 w-full max-w-[1652px] m-auto px-[13px] py-[40px] text-center' >
                    <div>
                        ...
                        <p className=' text-white text-[20px] leading[150%] font-[300]'>Wallets Onboarded</p>
                    </div>
                    <div>
                        <h1 className='spanText text-[60px] font-[500] leading-[120%]'><CountUp end={3} duration={5} />M+</h1>
                        <p className=' text-white text-[20px] leading[150%] font-[300]'>Transactions processed</p>
                    </div>
                    <div>
                        <h1 className='spanText text-[60px] font-[500] leading-[120%]'><CountUp end={200} duration={5} />K+</h1>
                        <p className=' text-white text-[20px] leading[150%] font-[300]'>Identities Created</p>
                    </div>
                    <div>
                        <h1 className='spanText text-[60px] font-[500] leading-[120%]'><CountUp end={500} duration={5} />K+</h1>
                        <p className=' text-white text-[20px] leading[150%] font-[300]'>Monthly Transaction Volume</p>
                    </div>
                    <div>
                        <h1 className='spanText text-[60px] font-[500] leading-[120%]'><CountUp end={200} duration={5} />K+</h1>
                        <p className=' text-white text-[20px] leading[150%] font-[300]'>Chats Created</p>
                    </div>
                    <div>
                        <h1 className='spanText text-[60px] font-[500] leading-[120%]'><CountUp end={200} duration={5} />+</h1>
                        <p className=' text-white text-[20px] leading[150%] font-[300]'>Countries Available</p>
                    </div>
                </div>
            </div>
        </>
