        ...
        <>
            <div className='w-full max-w-[1340px] flex justify-between flex-wrap m-auto px-[30px] mt-[267px] lg:gap-[0] gap-[20px] pb-[40px]'>
                <div className='primaryfont  lg:max-w-[300px] max-w-[100%] '>
                    ...
                    <p className={`text-[18px] font-[400] leading-[150%] mt-[10px] ${themetoggle === "dark" ? "text-white" : "text-[black]"} `}>Digiffer enhances your crypto
                    ...
                    <p className={`text-[18px] font-[400] leading-[150%] mt-[15px]${themetoggle === "dark" ? "text-white" : "text-[black]"} `}>Subscribe to our newsletter and be a
                ...
                <div className='primaryfont w-full sm:max-w-[300px] max-w-[100%]'>
                    ...
                    <ul className={`${themetoggle === "dark" ? "text-white" : "text-[black]"}`}>
                ...
                <div className='primaryfont max-w-[300px] text-[30px] font-[400] leading-[100%] text-left'>
                 ...
                 <p className={`text-[18px] font-[400] leading-[150%] mt-[10px] ${themetoggle === "dark" ? "text-white" : "text-[black]"} `}>support@digiffer.io</p>
